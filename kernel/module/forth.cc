...
//MEMORY
#define MEM_SIZE 65536 //main mem in bytes
#define STACK_SIZE 192 //cells reserved for stack
#define RSTACK_SIZE 64 //cells reserved for return stack
#define INPUT_LINE_SIZE 32 //bytes reserved for word buffer
...
//MEMORY GRAB
//I don't have alloc yet. we'll get back to this
byte memory[MEM_SIZE];

//FORTH VARIABLE POINTERS
cell *latest;
cell *here;
cell *base;
cell *state;
...
BUILTIN(25, "NOT",       fnot,            0)              { push(~pop()); }
